...
export function Navbar() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-0 z-[100] lg:hidden ${open ? "visible" : "invisible"}`}
      >
        <div
        ...
        />
        <aside
          className={`absolute inset-0 flex flex-col bg-white p-8 transition-transform duration-500 ${
            open ? "translate-x-0" : "translate-x-full"
          }`}
        >
          <div className="flex items-center justify-between">
            <span className="font-serif text-xl text-foreground">DOMEX KIDS</span>
            <button
              type="button"
